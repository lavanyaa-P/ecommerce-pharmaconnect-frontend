export const wellnessNutritionLevelThree = [
  ...
  { name: "Plant Protein", categoryId: "plant_protein", parentCategoryName: "Protein & Fitness", parentCategoryId: "protein_fitness" },
  { name: "Mass Gainers", categoryId: "mass_gainers", parentCategoryName: "Protein & Fitness", parentCategoryId: "protein_fitness" },
  { name: "Pre-Workout", categoryId: "pre_workout", parentCategoryName: "Protein & Fitness", parentCategoryId: "protein_fitness" },
  { name: "Post-Workout", categoryId: "post_workout", parentCategoryName: "Protein & Fitness", parentCategoryId: "protein_fitness" },

  // Herbal Supplements
  { name: "Ashwagandha Capsules", categoryId: "ashwagandha_capsules", parentCategoryName: "Herbal Supplements", parentCategoryId: "herbal_supplements" },
  ...
  { name: "Meal Replacements", categoryId: "meal_replacements", parentCategoryName: "Weight Management", parentCategoryId: "weight_management" },
  { name: "Appetite Suppressants", categoryId: "appetite_suppressants", parentCategoryName: "Weight Management", parentCategoryId: "weight_management" },
  { name: "Keto Supplements", categoryId: "keto_supplements", parentCategoryName: "Weight Management", parentCategoryId: "weight_management" },
];
